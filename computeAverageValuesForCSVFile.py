...
csvInput = pd.read_csv("MedianValuesForParameterization.csv", sep=" ", names=headers)
...
outputdf = outputdf.sort_values(['datapoints'])
outputdf.to_csv("MedianValuesForParameterization_merged.csv", sep=" ", index=False, header=False)
